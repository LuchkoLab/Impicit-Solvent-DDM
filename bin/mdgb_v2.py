...
#import restraint_finder as findrest --not working on it yet SA
...
def alter_parm_file(parm7_file, rst7_file, filepath, charge_val, Exclusions):
    ...
    '''
    print('parm7_file', parm7_file, 'rs7_file', rst7_file, 'filepath', filepath, 'charge_val', charge_val, 'Exc', Exclusions)
...
for argSet in simrun.args.generateSets():
    ...
    argSet.update(config['intial_MD'])
